...
session_start();
    ...
    include_once 'admin/include/user.php'; 
    $user=new User(); 
    ...
    { 
        extract($_REQUEST); 
        $result=$user->booknow($checkin, $checkout, $name, $phone, $email_id, $roomname);
        if($result)
        {
            ...
            <form action="" method="post" name="room_category">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="phone" placeholder="018XXXXXXXXX" required>
                </div>
                 <div class="form-group">
                    <label for="email_id">Enter Your Email:</label>
                    <input type="text" class="form-control" name="email_id" placeholder="xyz@gmail.com" required>
                </div> 
